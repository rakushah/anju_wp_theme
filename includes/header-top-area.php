		...
		<div class="column one">
			...
			<div class="top_bar_left clearfix">
				...
				<div class="menu_wrapper">
					<?php 
						if( mfn_opts_get( 'menu-style' ) != 'hide' ){
							
							// #menu --------------------------
							if( mfn_header_style() == 'header-split' ){
								// split
								mfn_wp_split_menu();
							} else {
								// default
					...
					echo '<div class="top_bar_right">';
						echo '<div class="top_bar_right_wrapper">';
							...
							if( $header_action_link ){
								$target = mfn_opts_get('header-action-target') ? 'target="_blank"' : false;
								echo '<a href="'. $header_action_link .'" class="button button_theme button_js action_button" '. $target .'><span class="button_label">'. mfn_opts_get( 'header-action-title' ) .'</span></a>';
							}
