...
if( ! function_exists( 'mfna_header_style' ) )
{
	function mfna_header_style(){
		return array(
			...
			'split'				=> array('title' => 'Split Menu (Page Options: Custom Menu is not supported)', 'img' => MFN_OPTIONS_URI.'img/select/header-split.png'),
		);
	}
}
	...
	function mfn_opts_setup(){
		...
		$menu = array(	
			...
			'general' => array(
				...
				'sections' 	=> array( 'general', 'advanced', 'sidebars', 'blog', 'portfolio', 'shop', 'sliders', 'hooks',  'under-construction' ),
			),
		...
		$sections['advanced'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'type' 		=> 'switch',
					'title' 	=> __('prettyPhoto | Title', 'mfn-opts'), 
				...
				array(
					...
					'desc' 		=> __('Disable animations for Counter, Quick fact', 'mfn-opts'),
					'options' 	=> array( '0' => 'Off', '1' => 'On' ),
					'std' 		=> '0'
				),
		...
		$sections['layout-header'] = array(
			...
			'fields' => array(
				...
				array(
					'id'		=> 'header-fw',
					'type'		=> 'switch',
					'title'		=> __('Header | Full Width', 'mfn-opts'),
					'desc' 		=> __('Works <strong>only</strong> with Layout: Full Width', 'mfn-opts'),
					'options'	=> array( '0' => 'Off', '1' => 'On' ),
				),
				...
				array(
					...
					'type'		=> 'switch',
					'title'		=> __('Action Button | Open link in new window', 'mfn-opts'),
					'options'	=> array( '1' => 'On', '0' => 'Off' ),
					'std'		=> '0'
				),
